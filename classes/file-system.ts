...
export default class FileSystem {
    ...
    getFotoUrl( userId: string, img: string ) { // metodo de file-systems
    ...
    imagenesDeTempHaciaOrden( ordenId: string ) {
    ...
    getFotoUrlOrden( userId: string, img: string ) { // metodo de file-systems
    ...
    guardarImagenTemporalOrden( file: FileUpload, ordenId: string ) {
